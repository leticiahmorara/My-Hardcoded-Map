...
import com.example.myhardcodedmaps.databinding.ActivityMapsBinding
...
private lateinit var binding: ActivityMapsBinding
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val kampala = LatLng(0.3133718,32.459036)
        mMap.addMarker(MarkerOptions().position(kampala).title("Marker in Kampala"))
        mMap.moveCamera(CameraUpdateFactory.newLatLng(kampala))

        val abuja = LatLng(9.0244189,7.3798268)
